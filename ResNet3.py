...
batchSize = 128  # The batch size used for learning
...
ResNet18 = ResNet(Block, [3,4,6,3])
print(ResNet18)
print("Total number of parameters: ", ResNet18.num_params())
...
optimizer = optim.SGD(ResNet18.parameters(), lr=learning_rate, momentum=momentum, weight_decay=5e-4)
